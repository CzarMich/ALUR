...
from config import (# Import the settings from the config file
    ...
    GPAS_BASE_URL, GPAS_ROOT_DOMAIN, GPAS_CLIENT_CERT, GPAS_CLIENT_KEY, GPAS_CA_CERT, EHR_SERVER_URL, EHR_SERVER_USER, EHR_SERVER_PASSWORD, FHIR_SERVER_URL, FHIR_SERVER_USER, FHIR_SERVER_PASSWORD, AUTH_METHOD, RESOURCES, RESOURCE_FILES)
